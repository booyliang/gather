...
<script>
  ...
  export default{
    ...
    async mounted()
    {
      let request={url:'/services/item/getItemInfoByUserId',method:"POST",body:{"createUserId":this.$env.custId}};
 			let projectVm= await this.$localStore.getOrSet('project',request,this.defaultProjectVm);
