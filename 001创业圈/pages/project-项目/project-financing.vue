...
<script>
  ...
  export default{
    ...
    mounted:function () {
      ...
      var projectFinancingDemandId=' '+(this.projectData.projectFinancingDemandId||'')+' '
      ...
      for(let item of resData ) {
        ...
        if(projectFinancingDemandId.indexOf(' '+item.designation+' ')>-1)
          tag.checked=true;
    ...
    methods:{
      submit:function () {
        ...
        var projectFinancingDemandId=tagValue.join(' ');
        this.projectData.projectFinancingDemandId = projectFinancingDemandId;
